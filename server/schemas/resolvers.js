...
const resolvers = {
  Query: {
    me: async (parent, args, context) => {
      // Get and return one document from the me collection, and populate the savedBooks subdocument for the user instance
  ...
  Mutation: {
    ...
    removeBook: async (parent, { bookId }, context) => {
      // Find and update the matching user using the destructured bookId arg
      if (context.user) {
        const updatedUser = await User.findOneAndUpdate(
          { _id: context.user._id },
